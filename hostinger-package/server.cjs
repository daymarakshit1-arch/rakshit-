...
var ELECTROBOLT_CATALOGUE = [
  ...
  },
  {
    ...
    stockQuantity: 60,
    keyFeatures: [
      "High air suction 550 m\xB3/hr to rapidly eliminate odor, heat and oil smoke",
    ...
    specs: {
      ...
      "Air Suction Volume": "550 m\xB3/hr",
      "RPM": "1300 RPM",
  ...
  },
  {
    ...
    stockQuantity: 7,
    keyFeatures: [
      "Heavy-duty cooling engineered for extreme ambient heat up to 55\xB0C",
  ...
  // ----------------------------------------------------
  {
    ...
    powerRating: "2000W (with 60\xB0C In-Built Heater)",
    ...
    keyFeatures: [
      ...
      "In-Built 90\xB0C Steam & Allergy Care wash eliminates 99.9% germs and dust mites",
    ...
    specs: {
      ...
      "Heater": "In-built variable temperature (20\xB0C to 90\xB0C)",
  ...
  // ----------------------------------------------------
  {
    ...
    powerRating: "Current Carrying Capacity: 16A @ 40\xB0C",
    ...
    specs: {
      ...
      "Max Operating Temp": "85\xB0C continuous / 105\xB0C thermal stability",
  ...
  },
  {
    ...
    powerRating: "Current Carrying Capacity: 24A @ 40\xB0C",
    warranty: "100% Pure Copper Guarantee / ISI & RoHS Certified",
    stockStatus: "In Stock",
    stockQuantity: 95,
    keyFeatures: [
  ...
  },
  {
    ...
    powerRating: "Current Carrying Capacity: 32A @ 40\xB0C",
    ...
    keyFeatures: [
      ...
      "Dual-layer heat resistant FR insulation with thermal withstand up to 105\xB0C",
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      "High CADR of 320 m\xB3/hr purifies a 250 sq ft room in just 12 minutes",
...
`;
function fallbackAdvisorResponse(userQuery, history) {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        temperature: 0.2
        // low temperature for high catalogue precision and factual grounding
      }
    });
